...
def test_dedup_keeps_recent_entry():
    ...
    art = {
        "title": "Primeira manchete válida para dedup",
        "summary": "Texto",
        "url": url,
    ...
    art2 = {
        "title": "Outra manchete totalmente distinta aqui",
        "summary": "Outro",
        "url": url,
        "image_url": "https://ex.com/img2.jpg",
    }
...
def test_content_filter_blocks_duplicate_url():
    ...
    f._redis = FakeRedis()
    a1 = {
        "title": "Treze mil vagas abertas em Campo Grande",
        "summary": "Governo anuncia",
        "url": "https://ex.com/a",
        "image_url": "img",
    }
    a2 = {
        "title": "Outra manchete totalmente diferente",
        "summary": "Outro texto",
        "url": "https://ex.com/a",
        "image_url": "img",
    }
...
def test_content_filter_blocks_similar_title():
    ...
    f._redis = FakeRedis()
    a1 = {
        "title": "Valor do combustível pode variar até 13,5% entre postos de Campo Grande",
        "summary": "Texto",
        "url": "https://ex.com/1",
        "image_url": "img",
    }
...
def test_scanner_blocks_generic_titles():
    ...
    assert (
        s._is_valid_article({"title": "O Estado Online", "url": "https://oestadoonline.com.br/homepage-nova-copy/"})
        is False
    )
    assert (
        s._is_valid_article(
            {
                "title": "Mercedita e serenatas - O Estado Online",
                "url": "https://oestadoonline.com.br/arte-e-lazer/mercedita-e-serenatas/",
            }
        )
        is False
    )
...
def test_scanner_allows_real_article():
    ...
    assert (
        s._is_valid_article(
            {
                "title": "TRE-MS retoma julgamento sobre mandato de Marquinhos Trad e analisa recurso",
                "url": "https://oestadoonline.com.br/politica/tre-ms-retoma-julgamento-sobre-mandato/",
            }
        )
        is True
    )
    assert (
        s._is_valid_article(
            {
                "title": "Valor do combustível pode variar até 13,5% entre postos de Campo Grande hoje",
                "url": "https://agenciadenoticias.ms.gov.br/valor-do-combustivel-pode-variar/",
            }
        )
        is True
    )
...
def test_scanner_blocks_homepage_root():
    ...
    assert (
        s._is_valid_article(
            {
                "title": "Notícia muito longa com título válido para passar no tamanho",
                "url": "https://oestadoonline.com.br/",
            }
        )
        is False
    )
    assert (
        s._is_valid_article(
            {
                "title": "Notícia muito longa com título válido para passar no tamanho",
                "url": "https://oestadoonline.com.br/a",
            }
        )
        is False
    )
...
def test_quality_score():
    f = ContentFilter()
    art = {
        "title": "Título com tamanho ideal para engajamento e leitura",
        "summary": "x" * 600,
        "source": "Agência MS",
        "url": "https://ex.com/a",
        "image_url": "https://ex.com/img.jpg",
