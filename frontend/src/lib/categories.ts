export const CATEGORIES = {
  tech: { label: "Tecnologia", iconClass: "laptop", color: "#e63946" },
  sports: { label: "Esportes", iconClass: "football", color: "#2a9d8f" },
  politics: { label: "Política", iconClass: "landmark", color: "#264653" },
  economy: { label: "Economia", iconClass: "chart", color: "#e9c46a", textDark: true },
  health: { label: "Saúde", iconClass: "hospital", color: "#e76f51" },
  security: { label: "Segurança", iconClass: "shield", color: "#9d0208" },
  science: { label: "Ciência", iconClass: "microscope", color: "#457b9d" },
  entertainment: { label: "Entretenimento", iconClass: "clapperboard", color: "#8338ec" },
  agriculture: { label: "Agronegócio", iconClass: "wheat", color: "#606c38" },
  education: { label: "Educação", iconClass: "graduation", color: "#0081a7" },
  culture: { label: "Cultura", iconClass: "palette", color: "#7209b7" },
  clima: { label: "Clima", iconClass: "cloud", color: "#0284c7" },
  general: { label: "Geral", iconClass: "newspaper", color: "#6c757d" },
} as const;
